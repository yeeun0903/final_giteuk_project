...
export default function GroupBuyBottomNav({
  ...
  const navItems = [
    ...
    { label: "커뮤니티", trackingLabel: "community", icon: figmaAssets.myNavCommunity, activeIcon: figmaAssets.navCommunity, onClick: onOpenCommunity },
    { label: "공동구매", trackingLabel: "groupbuy", icon: figmaAssets.myNavBuy, activeIcon: figmaAssets.navBuy, active: true, onClick: onOpenGroupbuy },
