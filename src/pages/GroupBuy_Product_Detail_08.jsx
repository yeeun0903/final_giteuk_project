...
import detailImage from "../assets/GroupBuy_Product_detail/kanu.png";
    ...
    <main className="groupbuy-page-shell">
      <section className="groupbuy-detail-frame" aria-label="상품 상세">
        <header className="groupbuy-detail-header">
          <button
            id="btn-groupbuy_detail_08-header-back"
        ...
        <section className="groupbuy-detail-content">
          ...
          <section className="groupbuy-detail-summary" aria-label="상품 요약">
            ...
            <h2>카누 미니 100T/150T</h2>
            <p>간편하게 즐기는 진한 아메리카노 대용량 구성</p>
            ...
            <div className="groupbuy-detail-progress">
              ...
              <div className="groupbuy-detail-progress-row">
                <div className="groupbuy-detail-progress-bar">
                  <span className="groupbuy-detail-progress-bar-kanu" />
                </div>
                <b>84%</b>
              </div>
            </div>
        ...
        <div className="groupbuy-detail-action-bar">
          <button id="btn-groupbuy_detail_08-bottom-share" className="groupbuy-detail-share-button" type="button" data-event="click_share" data-page="groupbuy_detail_08" data-section="bottom_actions" data-action="share" data-label="product_08">
            <img
          ...
          <button id="btn-groupbuy_detail_08-bottom-participate" className="groupbuy-detail-buy-button" type="button" data-event="click_participate" data-page="groupbuy_detail_08" data-section="bottom_actions" data-action="participate" data-label="product_08">
            <img
