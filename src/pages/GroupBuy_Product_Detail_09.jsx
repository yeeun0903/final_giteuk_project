...
import detailImage from "../assets/GroupBuy_Product_detail/shampoo.png";
...
const product = groupbuyProducts.find((item) => item.id === "shampoo");
...
export default function GroupBuyProductDetail09({ onBack, favoriteProductIds = null, onFavoriteIdsChange }) {
    ...
    <main className="groupbuy-page-shell">
      <section className="groupbuy-detail-frame" aria-label="상품 상세">
        <header className="groupbuy-detail-header">
          <button
            id="btn-groupbuy_detail_09-header-back"
            className="groupbuy-detail-back-button"
            type="button"
            aria-label="뒤로가기"
            data-event="click_back"
            data-page="groupbuy_detail_09"
            data-section="header"
            data-action="back"
            data-label="product_09"
            onClick={onBack}
          >
          ...
          <h1>상품 상세</h1>
          <button
            id="btn-groupbuy_detail_09-header-favorite"
        ...
        <section className="groupbuy-detail-content">
          <div className="groupbuy-detail-hero">
            <img
              ...
              src={detailImage}
              alt="닥터라파알 독일산 맥주효모 탈모 샴푸 1L x 2"
            />
          </div>
          ...
          <section className="groupbuy-detail-summary" aria-label="상품 요약">
            ...
            <h2 className="groupbuy-detail-title-wrap">
              닥터라파알 독일산 맥주효모 탈모 샴푸 1L x 2
            </h2>
            <p>두피와 모발을 산뜻하게 케어하는 대용량 샴푸 세트</p>
            ...
            <div className="groupbuy-detail-progress">
              ...
              <div className="groupbuy-detail-progress-row">
                <div className="groupbuy-detail-progress-bar">
                  <span className="groupbuy-detail-progress-bar-shampoo" />
                </div>
                <b>68%</b>
              </div>
            </div>
        ...
        <div className="groupbuy-detail-action-bar">
          <button id="btn-groupbuy_detail_09-bottom-share" className="groupbuy-detail-share-button" type="button" data-event="click_share" data-page="groupbuy_detail_09" data-section="bottom_actions" data-action="share" data-label="product_09">
            <img
          ...
          <button id="btn-groupbuy_detail_09-bottom-participate" className="groupbuy-detail-buy-button" type="button" data-event="click_participate" data-page="groupbuy_detail_09" data-section="bottom_actions" data-action="participate" data-label="product_09">
            <img
