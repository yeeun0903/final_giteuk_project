...
import detailImage from "../assets/GroupBuy_Product_detail/detergent.png";
...
const product = groupbuyProducts.find((item) => item.id === "detergent");
...
export default function GroupBuyProductDetail01({ onBack, favoriteProductIds = null, onFavoriteIdsChange }) {
  ...
  return (
    <main className="groupbuy-page-shell">
      <section
        className="groupbuy-detail-frame"
        aria-label="상품 상세"
        data-node-id="124:2300"
      >
        <header className="groupbuy-detail-header">
          <button
            id="btn-groupbuy_detail_01-header-back"
            className="groupbuy-detail-back-button"
            type="button"
            aria-label="뒤로가기"
            data-event="click_back"
            data-page="groupbuy_detail_01"
            data-section="header"
            data-action="back"
            data-label="product_01"
            onClick={onBack}
          >
          ...
          <h1>상품 상세</h1>
          <button
            id="btn-groupbuy_detail_01-header-favorite"
        ...
        <section className="groupbuy-detail-content">
          <div className="groupbuy-detail-hero">
            <img src={detailImage} alt="프로코 고농축 라벤더 세탁세제" />
          </div>
          ...
          <section className="groupbuy-detail-summary" aria-label="상품 요약">
            ...
            <h2>프로코 고농축 라벤더 세탁세제 2.5L 2+2</h2>
            <p>은은한 라벤더 퍼퓸 향과 강력한 세척력</p>
        ...
        <div className="groupbuy-detail-action-bar">
          <button id="btn-groupbuy_detail_01-bottom-share" className="groupbuy-detail-share-button" type="button" data-event="click_share" data-page="groupbuy_detail_01" data-section="bottom_actions" data-action="share" data-label="product_01">
            <img
          ...
          <button id="btn-groupbuy_detail_01-bottom-participate" className="groupbuy-detail-buy-button" type="button" data-event="click_participate" data-page="groupbuy_detail_01" data-section="bottom_actions" data-action="participate" data-label="product_01">
            <img
