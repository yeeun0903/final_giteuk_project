...
import detailImage from "../assets/GroupBuy_Product_detail/tissue.png";
...
const product = groupbuyProducts.find((item) => item.id === "tissue");
...
export default function GroupBuyProductDetail05({ onBack, favoriteProductIds = null, onFavoriteIdsChange }) {
    ...
    <main className="groupbuy-page-shell">
      <section className="groupbuy-detail-frame" aria-label="상품 상세">
        <header className="groupbuy-detail-header">
          <button
            id="btn-groupbuy_detail_05-header-back"
            className="groupbuy-detail-back-button"
            type="button"
            aria-label="뒤로가기"
            data-event="click_back"
            data-page="groupbuy_detail_05"
            data-section="header"
            data-action="back"
            data-label="product_05"
            onClick={onBack}
          >
          ...
          <h1>상품 상세</h1>
          <button
            id="btn-groupbuy_detail_05-header-favorite"
        ...
        <section className="groupbuy-detail-content">
          <div className="groupbuy-detail-hero">
            <img
              ...
              src={detailImage}
              alt="기분좋은선택 프리미엄 화장지 30M*24롤"
            />
          </div>

          <section className="groupbuy-detail-summary" aria-label="상품 요약">
            <div className="groupbuy-detail-category-row">
              <span className="groupbuy-detail-category">생활용품</span>
              <span className="groupbuy-detail-rating">
                <img src={ratingIcon} alt="" />
                {product.rating} (13970)
              </span>
            </div>

            <h2>기분좋은선택 프리미엄 화장지 30M*24롤</h2>
            <p>넉넉한 구성으로 오래 쓰는 프리미엄 생활 필수품</p>
        ...
        <div className="groupbuy-detail-action-bar">
          <button id="btn-groupbuy_detail_05-bottom-share" className="groupbuy-detail-share-button" type="button" data-event="click_share" data-page="groupbuy_detail_05" data-section="bottom_actions" data-action="share" data-label="product_05">
            <img
          ...
          <button id="btn-groupbuy_detail_05-bottom-participate" className="groupbuy-detail-buy-button" type="button" data-event="click_participate" data-page="groupbuy_detail_05" data-section="bottom_actions" data-action="participate" data-label="product_05">
            <img
