...
import detailImage from "../assets/GroupBuy_Product_detail/sun-bb.png";
...
const product = groupbuyProducts.find((item) => item.id === "sun-bb");
...
export default function GroupBuyProductDetail02({ onBack, favoriteProductIds = null, onFavoriteIdsChange }) {
    ...
    <main className="groupbuy-page-shell">
      <section className="groupbuy-detail-frame" aria-label="상품 상세">
        <header className="groupbuy-detail-header">
          <button
            id="btn-groupbuy_detail_02-header-back"
            className="groupbuy-detail-back-button"
            type="button"
            aria-label="뒤로가기"
            data-event="click_back"
            data-page="groupbuy_detail_02"
            data-section="header"
            data-action="back"
            data-label="product_02"
            onClick={onBack}
          >
          ...
          <h1>상품 상세</h1>
          <button
            id="btn-groupbuy_detail_02-header-favorite"
        ...
        <section className="groupbuy-detail-content">
          ...
          <section className="groupbuy-detail-summary" aria-label="상품 요약">
            ...
            <h2>커버천재 앙쥬 365 썬 비비크림</h2>
            <p>자외선 차단과 자연스러운 톤업 커버</p>
            ...
            <div className="groupbuy-detail-progress">
              ...
              <div className="groupbuy-detail-progress-row">
                <div className="groupbuy-detail-progress-bar">
                  <span className="groupbuy-detail-progress-bar-high" />
                </div>
                <b>92%</b>
              </div>
            </div>
        ...
        <div className="groupbuy-detail-action-bar">
          <button id="btn-groupbuy_detail_02-bottom-share" className="groupbuy-detail-share-button" type="button" data-event="click_share" data-page="groupbuy_detail_02" data-section="bottom_actions" data-action="share" data-label="product_02">
            <img
          ...
          <button id="btn-groupbuy_detail_02-bottom-participate" className="groupbuy-detail-buy-button" type="button" data-event="click_participate" data-page="groupbuy_detail_02" data-section="bottom_actions" data-action="participate" data-label="product_02">
            <img
